...
files_json = glob.glob("*_all_ids.json")
users = [u.split('_')[0] for u in files_json]
...
for user in users:
    ...
    file_user = [name for name in files_json if user in name][0]
