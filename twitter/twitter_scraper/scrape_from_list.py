...
# Download twitter up to today
today = datetime.datetime.now()
end = datetime.datetime(today.year, today.month, today.day)

for k in followers.keys():
    user = k
    beg_date = followers[k]
    start = datetime.datetime(beg_date.year, beg_date.month, beg_date.day)  # year, month, day
    # don't mess with this stuff
    twitter_ids_filename = user+'_all_ids.json'
